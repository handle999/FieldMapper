...
def sliding_predict(model, image, num_classes, flip=True):
    ...
    tile_size = (int(image_size[2]//4), int(image_size[3]//4))
    overlap = 1/4
...
def main():
    ...
    assert dataset_type in ['VOC', 'COCO', 'CityScapes', 'ADE20K', 'DeepScene', 'BCDI', 'CROP']
...
def parse_arguments():
    ...
    parser.add_argument('-i', '--images', default='inputs', type=str,
...
if __name__ == '__main__':
    main()
# python inference.py --model ./weights/ENet_BCDI_.pth --images ./data/CROP/img --output ./data/CROP/pred_enet_
# python inference.py --model ./weights/UNet_BCDI.pth --images ./data/CROP/img --output ./data/CROP/pred_unet
# python inference.py --model ./weights/PSPNet_BCDI.pth --images ./data/CROP/img --output ./data/CROP/pred_pspnet
# python inference.py --model ./weights/DeepLab_BCDI.pth --images ./data/CROP/img --output ./data/CROP/pred_deeplab
# python inference.py --model ./weights/SegNet_BCDI.pth --images ./data/CROP/img --output ./data/CROP/pred_segnet
# python inference.py --model ./weights/FCN8_BCDI.pth --images ./data/CROP/img --output ./data/CROP/pred_fcn8
# python inference.py --model ./weights/BsiNet_BCDI.pth --images ./data/CROP/img --output ./data/CROP/pred_bsinet

# python inference.py --model ./weights/REAUNet_BCDI.pth --images ./data/CROP/img --output ./data/CROP/pred_reaunet
# python inference.py --model ./weights/SEANet_BCDI.pth --images ./data/CROP/img --output ./data/CROP/pred_seanet
