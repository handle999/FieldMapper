...
class UperNet(BaseModel):
    ...
    def __init__(self, num_classes, in_channels=3, backbone='resnet101', pretrained=True, use_aux=True, fpn_out=256, freeze_bn=False, freeze_backbone=None,
                 **_):
...
if __name__ == "__main__":
    ...
    print(f"Total trainable parameters: {total_params:,}")  # 126,072,898
    # Downloading: "https://download.pytorch.org/models/resnet101-63fe2227.pth"
    # to
    # C:\Users\Highee/.cache\torch\hub\checkpoints\resnet101-63fe2227.pth
